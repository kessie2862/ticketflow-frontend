...
//                     >
//                       <div
//                         className={`w-2 h-2 rounded-full ${opt.id === 'HIGH' ? 'bg-rose-500' : opt.id === 'MEDIUM' ? 'bg-amber-500' : 'bg-slate-400'}`}
//                       />
//                       {opt.label}
//                     </button>
//                   ))}
...
//                     className={`
//                       w-full border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center gap-3 cursor-pointer transition-all
//                       ${file ? 'border-indigo-400 bg-indigo-50/30' : 'border-slate-200 bg-white hover:border-indigo-400 hover:bg-slate-50'}
//                     `}
//                   >
//                     <div className="p-3 bg-indigo-50 rounded-full text-indigo-600 group-hover:scale-110 transition-transform">
//                       <UploadCloud className="w-6 h-6" />
